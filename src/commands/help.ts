...
function HelpCommand(content : CommandStruct) : CommandStruct {
	content.responseEmbed.setTitle('List of available commands')
		.addFields(
			{ name: '*q or *queue', value: 'Start or join a queue. Add a number between 1 and 60 for how many minutes the q should be active for' },
			...
			{ name: '*r or *recent', value: 'Get the last 10 verified runs for rocket league'},
